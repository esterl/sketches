...
#np.savetxt("/Data/Sketches/AGMS/test_columns_%s_%s_%i_%i_%s.csv" % (sketch_type, random_generator, hash_length, num_pkts, run_id), results, delimiter=',', fmt="%s", header=header)
...
#header = ",".join(results.dtype.names)
#np.savetxt("/Data/Sketches/AGMS/test_rows_%s_%s_%i_%i_%s.csv" % (sketch_type, random_generator, hash_length, num_pkts, run_id), results, delimiter=',', fmt="%s", header=header)
...
header = ",".join(results.dtype.names)
np.savetxt("/Data/Sketches/AGMS/test_F2_%s_%s_%i_%i_%s.csv" % (sketch_type, random_generator, hash_length, num_pkts, run_id), results, delimiter=',', fmt="%s", header=header)
